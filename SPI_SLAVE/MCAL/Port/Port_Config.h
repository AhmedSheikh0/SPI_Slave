...
#define PORTB_PIN4_DIR         	STATE_INPUT			// SS
#define PORTB_PIN5_DIR         	STATE_INPUT			// MOSI
#define PORTB_PIN6_DIR          STATE_OUTPUT		// MISO
#define PORTB_PIN7_DIR          STATE_INPUT			// SCK

// PORT C Direction
#define PORTC_PIN0_DIR          STATE_OUTPUT
#define PORTC_PIN1_DIR          STATE_OUTPUT
#define PORTC_PIN2_DIR          STATE_INPUT
#define PORTC_PIN3_DIR          STATE_INPUT
